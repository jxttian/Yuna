...
(function ($) {
    ...
    _pop = function (id, e, mouse) {
        ...
        //刷新页面
        var $refresh = $('body ul.rightMenu a[data-right=refresh]');
        ...
        //关闭自身
        $('body ul.rightMenu a[data-right=remove]').on('click', function () {
        ...
        //关闭其他
        $('body ul.rightMenu a[data-right=remove-circle]').on('click', function () {
        ...
        //关闭左侧
        $('body ul.rightMenu a[data-right=remove-left]').on('click', function () {
            var tab_id = $(this).parent('ul').attr("aria-controls");
        ...
        //关闭右侧
        $('body ul.rightMenu a[data-right=remove-right]').on('click', function () {
    ...
    $.addtabs.close = function (opts) {
        if (opts.affirm) {
            ...
            var $tab_x = $("#tab_" + opts.id);
            var $x = $("#" + opts.id);
            if ($tab_x.hasClass('active')) {
                if ($tab_x.parents('li.tabdrop').length > 0 && !$tab_x.parents('li.tabdrop').hasClass('hide')) {
                    $tab_x.parents('.nav-tabs').find('li').last().addClass('active');
                } else {
                    $tab_x.prev('li').addClass('active');
                }
